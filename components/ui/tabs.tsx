...
export function TabsContent({ value, children, className }: TabsContentProps) {
  ...
  return (
    <div className={cn("mt-4 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2", className)}>
      {children}
    </div>
  )
}
